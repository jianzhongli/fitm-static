...
function post_new_homework() {
    $('#post-homework-modal-title').html('发布作业');
...
function edit_homework(homework_id) {
    $('#post-homework-modal-title').html('编辑作业');
    $('#modal-post-homework').openModal();
}
...
function open_upload_slide_modal() {
    $('#modal-upload-slide').openModal();
}

function upload_slide_to_server() {
